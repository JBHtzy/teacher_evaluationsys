<nav class="navbar navbar-expand-lg py-0">
    <div class="d-flex align-items-center py-3">
        ...
        <span class="fs-5 text-white text-uppercase fw-bold" id="companyname">Online Teachers Evaluation</span>
    </div>
    <!-- <div class="collapse navbar-collapse pe-5 justify-content-end" id="navbarNav">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="../assets\imgs\user.png" width="30" alt="">
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="profile-admin.php"><i class="fa-solid fa-user"></i> Profile</a></li>
